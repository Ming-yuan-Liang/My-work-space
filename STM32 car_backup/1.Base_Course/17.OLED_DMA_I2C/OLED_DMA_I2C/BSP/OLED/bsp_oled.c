...
// 0：不使用DMA  1：使用DMA
// 0: Do not use DMA 1: Use DMA
#define DMA_I2C_USE 1
...
#else
    // 使用DMA的方式传输-非阻塞型
    // Transmission using DMA - Non blocking
    while (hi2c1.State != HAL_I2C_STATE_READY)
        ;
    HAL_I2C_Mem_Write_DMA(&hi2c1, OLED_ADDRESS, addr, I2C_MEMADD_SIZE_8BIT, &data, 1);
#endif
}

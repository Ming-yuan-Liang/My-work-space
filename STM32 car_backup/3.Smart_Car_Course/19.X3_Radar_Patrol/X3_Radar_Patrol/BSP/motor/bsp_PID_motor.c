...
float PID_Yaw_Calc(float NextPoint)
{
    ...
    if(my_abs(pid_Yaw.SetPoint - NextPoint) > 10 && NextPoint > pid_Yaw.SetPoint)
    {
			Error = NextPoint - pid_Yaw.SetPoint ;
    }
    else
    {
			Error = pid_Yaw.SetPoint - NextPoint;
    }

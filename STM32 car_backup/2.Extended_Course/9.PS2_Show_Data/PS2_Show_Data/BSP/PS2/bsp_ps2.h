...
#define DO_H HAL_GPIO_WritePin(PS_DO_GPIO_Port, PS_DO_Pin, GPIO_PIN_SET)   // Command bit high 命令位高
#define DO_L HAL_GPIO_WritePin(PS_DO_GPIO_Port, PS_DO_Pin, GPIO_PIN_RESET) // Command bit low 命令位低

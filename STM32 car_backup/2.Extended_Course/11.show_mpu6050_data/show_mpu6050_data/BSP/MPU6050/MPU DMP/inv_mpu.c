 ...
 * delay_ms_mpu(unsigned long num_ms)
...
#define i2c_write   i2cwrite_mpu
#define i2c_read    i2cread_mpu
#define delay_ms_mpu    delay_ms_mpu
...
#define delay_ms_mpu    msp430_delay_ms
...
/* delay_ms_mpu is a function already defined in ASF. */
